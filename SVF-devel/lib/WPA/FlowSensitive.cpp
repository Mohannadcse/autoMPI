...
void FlowSensitive::analyze(llvm::Module& module) {
    ...
    std::cout << "Call graph SCC created." << std::endl;
    ...
    do {
        ...
        std::cout << "Before finding call graph SCC in iteration" << std::endl;
        callGraphSCC->find();
        std::cout << "After finding call graph SCC in iteration" << std::endl;

        solve();
        std::cout << "After one analysis iteration" << std::endl;
